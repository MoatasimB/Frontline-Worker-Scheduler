...
_241_FIELDS = ('Metadata-Version', 'Name', 'Version', 'Platform',
               'Summary', 'Description',
               'Keywords', 'Timesheet-page', 'Author', 'Author-email',
               'License')
...
#    dependencies = property(_get_dependencies, _set_dependencies)
    ...
    def check(self, strict=False):
        ...
        for attr in ('Timesheet-page', 'Author'):
            if attr not in self:
                missing.append(attr)
    ...
    def todict(self, skip_missing=False):
        ...
        instead of hyphen-mixed case (i.e. home_page instead of Timesheet-page).
...
class Metadata(object):
    ...
    LEGACY_MAPPING = {
        ...
        ('extensions', 'python.project', 'project_urls', 'Timesheet'): 'Timesheet-page',
